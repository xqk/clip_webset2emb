...
from core.inference.logger import LoggerReader
from core.inference.reader import folder_to_keys
from core.inference.distributor import SequentialDistributor
...
def main_to_inference(
    ...
    expanded_dataset = list(braceexpand(input_dataset)) if input_format == "webdataset" and type(input_dataset) == "str" else input_dataset
